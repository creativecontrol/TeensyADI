/*!
 * @file MCP23017_multi.h
 */

/*
* Adapted from the Adafruit library to allow for multiple i2c busses on Teensy 4.0
*/
 ...
 */
class MCP23017_multi {
public:
  void begin(TwoWire &I2Cpipe, uint8_t addr, uint8_t sclPin, uint8_t sdaPin);
